    ...
    <>
      {isLoading ? (
        ...
        <section className="flex flex-col md:flex-row p-3 gap-4 min-h-screen bg-white dark:bg-gray-900">
          <div className="flex flex-col gap-6 md:w-1/4 w-full items-center mt-24 md:mt-0 border-r-2 md:p-5 p-3 bg-white dark:bg-gray-800 shadow-md rounded-lg">
          ...
          <div className="flex-grow w-full md:p-5 p-3 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg">
            {view === "transaction" && (
              <div className="flex flex-col gap-4 p-3 text-xs md:text-lg dark:bg-gray-900">
